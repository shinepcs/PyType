...
오타와 목표 시간을 넘긴 문제는 같은 세션에서 3~7문제 뒤 다시 등장합니다. 정확도, WPM, 실시간 초당 타수, 콤보, 점수, 위험도, 문법별 숙련도는 `PRD.md`의 공식으로 계산됩니다. 각 모드의 결과 화면에서는 같은 모드·같은 Practice 설정의 직전 기록과 최근 5회 평균을 비교해 점수, 정확도, WPM, 해결 수, 문제당 평균 시간의 변화를 보여줍니다. 제한시간은 온라인 랭크 대상인 Quick Play에만 적용됩니다.
