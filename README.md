...
Level 2에서는 미입력 정답 문자를 화면에 미리 표시하지 않습니다. Quick Play에서는 문제를 푸는 동안 세션 시간과 위험도가 멈추며, 완료하면 3초 보너스, 첫 오타에는 한 번만 2초 패널티가 적용됩니다. 이 규칙 이후 Quick 랭킹은 `1.0.0-r2` 그룹으로 분리됩니다.
