...
test("production repository excludes an invalid item while strict validation still fails", () => {
  ...
  assert.equal(repository.getAll({ seed: "production-salvage" }).length, 397);
});
